...
interface TimelockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "managedSetHandler(address,address,bool)": FunctionFragment;
    "managedSetMinter(address,address,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "managedSetHandler",
    values: [string, string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "managedSetMinter",
    values: [string, string, boolean]
  ): string;
  encodeFunctionData(

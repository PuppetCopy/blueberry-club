...
interface FastPriceFeedInterface extends ethers.utils.Interface {
  functions: {
    ...
    "favorFastPrice()": FunctionFragment;
    ...
    "setPricesWithBitsAndExecute(uint256,uint256,uint256,uint256)": FunctionFragment;
    ...
    "volBasisPoints()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "setVolBasisPoints",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "volBasisPoints",
    values?: undefined
  ): string;
...
export class FastPriceFeed extends BaseContract {
  ...
  functions: {
    ...
    favorFastPrice(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    volBasisPoints(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  estimateGas: {
    ...
    favorFastPrice(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    favorFastPrice(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    volBasisPoints(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}

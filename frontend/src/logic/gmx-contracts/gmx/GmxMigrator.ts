...
export interface GmxMigrator extends BaseContract {
  ...
  hasMaxMigrationLimit: TypedContractMethod<[], [boolean], "view">;
  ...
  maxMigrationAmounts: TypedContractMethod<
  ...
  migratedAmounts: TypedContractMethod<
    [arg0: AddressLike, arg1: AddressLike],
    [bigint],
    "view"
  >;
  ...
  setHasMaxMigrationLimit: TypedContractMethod<
    [_hasMaxMigrationLimit: boolean],
    [void],
    "nonpayable"
  >;

  setMaxMigrationAmount: TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "hasMaxMigrationLimit"
  ...
  getFunction(
    nameOrSignature: "maxMigrationAmounts"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: AddressLike],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "migratedAmounts"
  ): TypedContractMethod<
    [arg0: AddressLike, arg1: AddressLike],
    [bigint],
    "view"
  ...
  getFunction(
    nameOrSignature: "setHasMaxMigrationLimit"
  ): TypedContractMethod<
    [_hasMaxMigrationLimit: boolean],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setMaxMigrationAmount"
  ): TypedContractMethod<
    [
      _account: AddressLike,
      _token: AddressLike,

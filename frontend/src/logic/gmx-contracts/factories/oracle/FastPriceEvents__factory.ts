...
type FastPriceEventsConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: FastPriceEventsConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class FastPriceEvents__factory extends ContractFactory {
  constructor(...args: FastPriceEventsConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): FastPriceEvents__factory {
    return super.connect(runner) as FastPriceEvents__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FastPriceEventsInterface {
    return new Interface(_abi) as FastPriceEventsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): FastPriceEvents {
    return new Contract(address, _abi, runner) as unknown as FastPriceEvents;
  }
}

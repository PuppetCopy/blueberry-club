...
} from "../../../oracle/interfaces/IFastPriceFeed";
...
export class IFastPriceFeed__factory {
  ...
  static createInterface(): IFastPriceFeedInterface {
    return new Interface(_abi) as IFastPriceFeedInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IFastPriceFeed {
    return new Contract(address, _abi, runner) as unknown as IFastPriceFeed;
  }
}

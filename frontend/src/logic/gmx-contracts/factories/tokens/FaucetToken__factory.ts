...
export class FaucetToken__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): FaucetToken__factory {
    return super.connect(runner) as FaucetToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FaucetTokenInterface {
    return new Interface(_abi) as FaucetTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FaucetToken {
    return new Contract(address, _abi, runner) as unknown as FaucetToken;
  }
}

...
import type { UniPool, UniPoolInterface } from "../../amm/UniPool";
...
type UniPoolConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: UniPoolConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class UniPool__factory extends ContractFactory {
  constructor(...args: UniPoolConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): UniPool__factory {
    return super.connect(runner) as UniPool__factory;
  }

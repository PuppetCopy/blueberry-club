...
import type {
  UniNftManager,
  UniNftManagerInterface,
} from "../../amm/UniNftManager";
...
type UniNftManagerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: UniNftManagerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class UniNftManager__factory extends ContractFactory {
  constructor(...args: UniNftManagerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): UniNftManager__factory {
    return super.connect(runner) as UniNftManager__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): UniNftManagerInterface {
    return new Interface(_abi) as UniNftManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): UniNftManager {
    return new Contract(address, _abi, runner) as unknown as UniNftManager;
  }
}
